...
const gtfs = new Gtfs("https://opendata.samtrafiken.se/gtfs/sl/sl.zip");

const trafiklab_api_key = "5c92c54fc43842709df5e54ff3b2424d";
...
function convertToJson(csvInput, outputFile) {
    var array = csvInput.toString().split(/\r?\n/);
    let result = [];
